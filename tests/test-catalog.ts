...
export const TEST_CASES: TestCase[] = [
  // ---- LOG IN ----
  { id: 'IA-FM01-F01-TC01', row: 3, section: 'LOG IN', title: 'Successful Login by Active Instance Admin', expected: 'User is authenticated successfully and redirected to the Instance Admin Dashboard', mode: 'readonly' },
  { id: 'IA-FM01-F01-TC02', row: 4, section: 'LOG IN', title: 'Login with Incorrect Password', expected: 'Login fails and an error message indicating invalid credentials is displayed', mode: 'readonly' },
  ...
  { id: 'IA-FM01-F01-TC06', row: 8, section: 'LOG IN', title: 'Unauthorized Access to System Admin URLs', expected: 'Access is denied and user is redirected to the login page', mode: 'readonly' },

  // ---- DASHBOARD AND NAVIGATION MENU ACCESS ----
  { id: 'IA-AL01-F02-TC01', row: 10, section: 'DASHBOARD AND NAVIGATION MENU ACCESS', title: 'Dashboard Metrics Load Correctly', expected: 'Dashboard metrics display accurate data matching backend records', mode: 'readonly' },
  { id: 'IA-AL01-F02-TC02', row: 11, section: 'DASHBOARD AND NAVIGATION MENU ACCESS', title: 'View top rated items', expected: 'Top rated items are displayed on the dashboard', mode: 'readonly' },
  { id: 'IA-AL01-F02-TC03', row: 12, section: 'DASHBOARD AND NAVIGATION MENU ACCESS', title: 'Access to Authorized Sections', expected: 'Access is granted to all instance level functions', mode: 'readonly' },

  // ---- USER MANAGEMENT ----
  { id: 'IA-FM01-F15-TC01', row: 14, section: 'USER MANAGEMENT', title: 'View User List', expected: 'List of users displayed with key attributes', mode: 'readonly' },
  { id: 'IA-FM01-F15-TC02', row: 15, section: 'USER MANAGEMENT', title: 'Search User by Name or Email', expected: 'Matching users returned; no irrelevant users displayed', mode: 'readonly' },
  { id: 'IA-FM01-F15-TC03', row: 16, section: 'USER MANAGEMENT', title: 'Filter Users by Location', expected: 'Only users from selected country are displayed', mode: 'readonly' },
  { id: 'IA-FM01-F15-TC04', row: 17, section: 'USER MANAGEMENT', title: 'Filter Users by Role', expected: 'Users displayed match selected role', mode: 'readonly' },
  { id: 'IA-FM01-F15-TC05', row: 18, section: 'USER MANAGEMENT', title: 'Filter Users by Status', expected: 'Only users with selected status are shown', mode: 'readonly' },
  { id: 'IA-FM01-F15-TC06', row: 19, section: 'USER MANAGEMENT', title: 'View User Profile Details', expected: 'Full user profile displayed', mode: 'readonly' },
  ...
  { id: 'IA-FM01-F15-TC08', row: 21, section: 'USER MANAGEMENT', title: 'Restriction on User profile edits', expected: "System blocks editing of user's phone number and email", mode: 'readonly' },
  ...
  { id: 'IA-FM01-F03-TC01', row: 27, section: 'ROLE AND PERMISSION ASSIGNMENT', title: 'Create New Role', expected: 'Role created successfully', mode: 'write' },
  { id: 'IA-FM01-F03-TC02', row: 28, section: 'ROLE AND PERMISSION ASSIGNMENT', title: 'Create Role with Missing Mandatory Fields', expected: 'Validation error displayed', mode: 'write' },
  { id: 'IA-FM01-F03-TC03', row: 29, section: 'ROLE AND PERMISSION ASSIGNMENT', title: 'Create Duplicate Role', expected: 'System prevents duplication', mode: 'write' },
  { id: 'IA-FM01-F03-TC04', row: 30, section: 'ROLE AND PERMISSION ASSIGNMENT', title: 'Edit Role Details', expected: 'Changes saved successfully', mode: 'write' },
  { id: 'IA-FM01-F03-TC05', row: 31, section: 'ROLE AND PERMISSION ASSIGNMENT', title: 'View Role Details', expected: 'All permissions and metadata visible', mode: 'readonly' },
  { id: 'IA-FM01-F03-TC06', row: 32, section: 'ROLE AND PERMISSION ASSIGNMENT', title: 'Deactivate Role', expected: 'Role marked inactive', mode: 'write' },
  { id: 'IA-FM01-F03-TC07', row: 33, section: 'ROLE AND PERMISSION ASSIGNMENT', title: 'Reactivate Role', expected: 'Role restored', mode: 'write' },
  { id: 'IA-FM01-F03-TC08', row: 34, section: 'ROLE AND PERMISSION ASSIGNMENT', title: 'Assign Permission to Role', expected: 'Permission assigned', mode: 'write' },
  { id: 'IA-FM01-F03-TC09', row: 35, section: 'ROLE AND PERMISSION ASSIGNMENT', title: 'Assign Multiple Permissions', expected: 'All permissions applied', mode: 'write' },
  { id: 'IA-FM01-F03-TC10', row: 36, section: 'ROLE AND PERMISSION ASSIGNMENT', title: 'Remove Permission', expected: 'Role loses capability', mode: 'write' },
  { id: 'IA-FM01-F03-TC11', row: 37, section: 'ROLE AND PERMISSION ASSIGNMENT', title: 'Remove All Permissions', expected: 'Role has no access', mode: 'write' },
  ...
  { id: 'IA-FM01-F10-TC01', row: 47, section: 'LOCATION AND LOCATION LEVEL', title: 'Create location level (no parent)', expected: 'Level created successfully', mode: 'write' },
  { id: 'IA-FM01-F10-TC02', row: 48, section: 'LOCATION AND LOCATION LEVEL', title: 'Create Child Location Level', expected: 'Location level created and linked to parent', mode: 'write' },
  { id: 'IA-FM01-F10-TC03', row: 49, section: 'LOCATION AND LOCATION LEVEL', title: 'Create Location Level Without Name', expected: 'Validation error displayed', mode: 'write' },
  { id: 'IA-FM01-F10-TC04', row: 50, section: 'LOCATION AND LOCATION LEVEL', title: 'Create Duplicate Location Level', expected: 'Duplicate prevented', mode: 'write' },
  { id: 'IA-FM01-F10-TC05', row: 51, section: 'LOCATION AND LOCATION LEVEL', title: 'Deactivate Location Level', expected: 'Level marked inactive', mode: 'write' },
  { id: 'IA-FM01-F10-TC06', row: 52, section: 'LOCATION AND LOCATION LEVEL', title: 'Activate Location Level', expected: 'Level reactivated', mode: 'write' },
  ...
  { id: 'IA-FM01-F10-TC08', row: 54, section: 'LOCATION AND LOCATION LEVEL', title: 'Visibility of Inactive Levels', expected: 'Inactive not visible', mode: 'write' },
  { id: 'IA-FM01-F10-TC09', row: 55, section: 'LOCATION AND LOCATION LEVEL', title: 'Create Parent Location (no parent)', expected: 'Location created', mode: 'write' },
  { id: 'IA-FM01-F10-TC10', row: 56, section: 'LOCATION AND LOCATION LEVEL', title: 'Create child location', expected: 'Location created and linked to parent', mode: 'write' },
  { id: 'IA-FM01-F10-TC11', row: 57, section: 'LOCATION AND LOCATION LEVEL', title: 'Create Location Under Inactive Level', expected: 'Inactive level not listed in options', mode: 'write' },
  { id: 'IA-FM01-F10-TC12', row: 58, section: 'LOCATION AND LOCATION LEVEL', title: 'Create Location with Missing Fields', expected: 'Validation error', mode: 'write' },
  { id: 'IA-FM01-F10-TC13', row: 59, section: 'LOCATION AND LOCATION LEVEL', title: 'Create Duplicate Location', expected: 'Duplicate prevented', mode: 'write' },
  { id: 'IA-FM01-F10-TC14', row: 60, section: 'LOCATION AND LOCATION LEVEL', title: 'Change Parent Location', expected: 'Parent updated', mode: 'write' },
  { id: 'IA-FM01-F10-TC15', row: 61, section: 'LOCATION AND LOCATION LEVEL', title: 'Deactivate Location', expected: 'Location inactive', mode: 'write' },
  { id: 'IA-FM01-F10-TC16', row: 62, section: 'LOCATION AND LOCATION LEVEL', title: 'Activate Location', expected: 'Location active', mode: 'write' },
  ...
  // ---- EXPORT USERLIST ----
  { id: 'IA-FM01-F15-TC14', row: 65, section: 'EXPORT USERLIST', title: 'Export All Users', expected: 'All users exported', mode: 'readonly' },
  ...
  { id: 'IA-FM01-F15-TC16', row: 67, section: 'EXPORT USERLIST', title: 'File Naming Convention', expected: 'Name includes date/time', mode: 'readonly' },
  { id: 'IA-FM01-F15-TC17', row: 68, section: 'EXPORT USERLIST', title: 'XLS File Opens Correctly', expected: 'No corruption', mode: 'readonly' },
  { id: 'IA-FM01-F15-TC18', row: 69, section: 'EXPORT USERLIST', title: 'Header Row Validation', expected: 'Correct column names', mode: 'readonly' },
  { id: 'IA-FM01-F15-TC19', row: 70, section: 'EXPORT USERLIST', title: 'User Count Validation', expected: 'Counts match', mode: 'readonly' },
  { id: 'IA-FM01-F15-TC20', row: 71, section: 'EXPORT USERLIST', title: 'Data Formatting Validation', expected: 'Correct data types', mode: 'readonly' },
  { id: 'IA-FM01-F15-TC21', row: 72, section: 'EXPORT USERLIST', title: 'Export Filtered by Location', expected: 'Only selected country users', mode: 'readonly' },
  { id: 'IA-FM01-F15-TC22', row: 73, section: 'EXPORT USERLIST', title: 'Export Filtered by Association', expected: 'Correct subset exported', mode: 'readonly' },
  { id: 'IA-FM01-F15-TC23', row: 74, section: 'EXPORT USERLIST', title: 'Export Filtered by Role', expected: 'Role-specific users exported', mode: 'readonly' },
  { id: 'IA-FM01-F15-TC24', row: 75, section: 'EXPORT USERLIST', title: 'Export Filtered by Status', expected: 'Only matching users', mode: 'readonly' },
  { id: 'IA-FM01-F15-TC25', row: 76, section: 'EXPORT USERLIST', title: 'Export Filtered by Date Range', expected: 'Correct subset exported', mode: 'readonly' },
  { id: 'IA-FM01-F15-TC26', row: 77, section: 'EXPORT USERLIST', title: 'Export with Multiple Filters', expected: 'All conditions respected', mode: 'readonly' },
  { id: 'IA-FM01-F15-TC27', row: 78, section: 'EXPORT USERLIST', title: 'Export Empty Result Set', expected: 'Empty file or warning', mode: 'readonly' },

  // ---- ASSOCIATION MANAGEMENT ----
  { id: 'IA-CM05-F01-TC01', row: 80, section: 'ASSOCIATION MANAGEMENT', title: 'View Associations List', expected: 'List of all registered associations displayed with key details', mode: 'readonly' },
  { id: 'IA-CM05-F01-TC02', row: 81, section: 'ASSOCIATION MANAGEMENT', title: 'Search Association', expected: 'Matching associations returned accurately', mode: 'readonly' },
  { id: 'IA-CM05-F01-TC03', row: 82, section: 'ASSOCIATION MANAGEMENT', title: 'Filter Associations by Location', expected: 'Only associations from selected country displayed', mode: 'readonly' },
  { id: 'IA-CM05-F01-TC04', row: 83, section: 'ASSOCIATION MANAGEMENT', title: 'Filter Associations by Status', expected: 'Associations displayed match selected status', mode: 'readonly' },
  { id: 'IA-CM05-F01-TC05', row: 84, section: 'ASSOCIATION MANAGEMENT', title: 'Review Association Registration Application', expected: 'Full application details visible; documents accessible', mode: 'readonly' },
  ...
  { id: 'IA-CM05-F01-TC10', row: 88, section: 'ASSOCIATION MANAGEMENT', title: 'View Association Profile', expected: 'Profile details displayed', mode: 'readonly' },
  ...
  { id: 'IA-CM05-F01-TC12', row: 90, section: 'ASSOCIATION MANAGEMENT', title: 'Monitor Association Members', expected: 'List of members displayed with status', mode: 'readonly' },
  ...
  { id: 'IA-CM05-F01-TC16', row: 94, section: 'ASSOCIATION MANAGEMENT', title: 'Verify Association Marketplace Page', expected: 'Marketplace page visible; member listings aggregated', mode: 'readonly' },

  // ---- ADMIN ORDER MANAGEMENT ----
  { id: 'IA-CM02-F08-TC01', row: 96, section: 'ADMIN ORDER MANAGEMENT', title: 'View Newly Placed Order', expected: 'Order displayed with correct details', mode: 'readonly' },
  { id: 'IA-CM02-F08-TC02', row: 97, section: 'ADMIN ORDER MANAGEMENT', title: 'Validate Order Details', expected: 'Product, unit, price, totals accurate', mode: 'readonly' },
  { id: 'IA-CM02-F08-TC03', row: 98, section: 'ADMIN ORDER MANAGEMENT', title: 'Default Status Validation', expected: 'Status = Pending', mode: 'readonly' },
  ...
  { id: 'IA-FM01-F22-TC01', row: 116, section: 'EMAIL AND SMS TEMPLATE CONFIGURATION', title: 'View list of email Templates', expected: 'List of email templates displays', mode: 'readonly' },
